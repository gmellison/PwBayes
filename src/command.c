...
CmdType     commands[] =
            ...
            { 24,            "Lset",  NO,            DoLset, 23,                         {28,29,30,31,32,33,34,40,51,52,53,90,91,131,188,189,276,277,280,282,286,287,288},        4,                "Sets the parameters of the likelihood model",  IN_CMD, SHOW },
