...
#define NUMPARAMS                       297   /* The total number of parameters  */
...
void SetUpParms (void)
{
    ...
    PARAM (294, "Initrunfname",   DoMcmcParm,        "\0");
    PARAM (295, "Initrunburnin",  DoMcmcParm,        "\0");
    PARAM (296, "Initsamplefreq", DoMcmcParm,        "\0");
